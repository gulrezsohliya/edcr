...
@Service
public class RainWaterHarvesting_Tripura extends RainWaterHarvesting {
	...
	private static final Logger LOG = Logger.getLogger(RainWaterHarvesting_Tripura.class);
...
//			scrutinyDetail.addColumnHeading(3, REQUIRED);
			...
			if(!req) {
				if (pl.getUtility().getRainWaterHarvestingTankCapacity() != null
					...
					setReportOutputDetails(pl, RULE_110_a_3, RULE_51_DESCRIPTION, "", "Defined in the plan",

...
@Service
public class HeadRoom_Tripura extends HeadRoom{

	private static final Logger LOG = Logger.getLogger(HeadRoom_Tripura.class);
                ...
                try {
                     ...
                     if (headRoom != null) {
                         ...
                         if (headRoomDimensions != null && headRoomDimensions.size() > 0) {
                             ...
                             if (minWidth.compareTo(TWO_POINTONE) >= 0) {

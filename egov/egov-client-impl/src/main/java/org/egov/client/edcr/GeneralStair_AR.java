...
public class GeneralStair_AR extends GeneralStair {
	...
	private static final String RULE42_5_II = "4.18.2";
...
//					                            mostRestrictiveOccupancyType,buildingHeight,size);
    ...
    private void validateNoOfStairs(Plan plan, ScrutinyDetail scrutinyDetail3,Floor floor2,
			...
			if(noofstairs>=reqnoofStairs) {
			 ...
			 if (valid) {
	                setReportOutputDetailsFloorWise(plan, "4.18.2", reqnoofStairs,
	                        noofstairs, Result.Accepted.getResultVal(), scrutinyDetail3,floor2.getNumber());
	                setReportOutputDetailsFloorStairWise(plan, "4.18.2",floor2.getNumber()+"","No of stairs", reqnoofStairs+"",noofstairs+"",Result.Accepted.getResultVal(), scrutinyDetail3);
    ...
    private void validateLanding(Plan plan, Block block, ScrutinyDetail scrutinyDetailLanding,
        ...
        for (StairLanding landing : landings) {
            ...
            if (!(Boolean) typicalFloorValues.get("isTypicalRepititiveFloor")) {
                ...
                if (valid) {
                    setReportOutputDetailsFloorStairWise(plan, "4.18.2", value,
    ...
    private BigDecimal getRequiredWidth(Block block, OccupancyTypeHelper mostRestrictiveOccupancyType,String stairno) {
			if (mostRestrictiveOccupancyType != null && mostRestrictiveOccupancyType.getType() != null
				...
				BigDecimal nooffloors=block.getBuilding().getTotalFloors();	
	        	if(nooffloors.compareTo(BigDecimal.valueOf(2))<=0) {
	        		return BigDecimal.valueOf(0.9);
	        	}else {
	        		return BigDecimal.valueOf(1.2);
	        	}
	            
	        }else if(C2a.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())) {
	        	return BigDecimal.valueOf(1.5);
	    	}else if(P3a.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P3b.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P3c.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())) {
	        		return BigDecimal.valueOf(2);
	    	}else if(P1b.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1c.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1d.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1e.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1f.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1g.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())) {
	    		return BigDecimal.valueOf(1.5);
	    	}else if(P2a.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P2b.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P2c.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P2d.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1f.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())
	    			|| P1g.equalsIgnoreCase(mostRestrictiveOccupancyType.getSubtype().getCode())) {
	    		return BigDecimal.valueOf(2);
	    	}

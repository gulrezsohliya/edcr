									...
									if (occupancy.getTypeHelper().getType() == null) {
										...
										if (mostRestrictiveOccupancyType != null) {
											if(buildingHeight.compareTo(BigDecimal.valueOf(15))>0 && stiltExist==Boolean.FALSE
												...
												frontYardResult =frontSetbackHighRise(setback, block.getBuilding(), pl,
...
//								details.put(RULE_NO, frontYardResult.subRule);
	...
	private FrontYardResult frontSetbackHighRise(SetBack setback, Building building, Plan pl, Block block, Integer level,
